<?php 
    ...
    $QUERYES = mysqli_query($con,"SELECT AU.ROL FROM DB_ACADEMICO.USUARIO AU WHERE AU.USUARIO = '$USER'");
    $dateROL = mysqli_fetch_array($QUERYES);
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../table/css/icons.css" />
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="preInscripcion.php"> <span class="sr-only">(current)</span></a>
                </li>
                <!--<li class="nav-item">
                    <a class="nav-link page-scroll" href="#intro">INTRO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#about"><span>ACADÉMICO</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services"><span>CARRERAS&nbsp;&nbsp;&nbsp;</span></a>
                </li>-->
                ...
                <li class="nav-item dropdown" style="margin-top:-8px; ">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#"><span class="item-text"><?php echo $dateROL["ROL"]; ?></span></a>
